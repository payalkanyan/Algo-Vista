  ...
  return (
    <header
      className={`fixed z-10 w-full transition duration-300 ease-in-out ${
        !top && "bg-pink-100 backdrop-blur-sm shadow-lg"
      }`}
    >
        ...
        <nav>
          <ul className="flex grow justify-end flex-wrap items-center gap-5 text-lg">
            <li>
              <Link
                to="/"
                className="font-medium hover:text-red-500 text-gray-700 flex items-center transition duration-150 ease-in-out"
              >
                Home
              </Link>
            </li>
