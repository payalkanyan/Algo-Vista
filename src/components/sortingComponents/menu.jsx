  ...
  render() {
    return (
      <div className="flex justify-center items-center bg-gray-200 gap-10 py-2">
        <Link
          to="/visualize"
          className="font-bold py-2 px-5 pl-6 bg-red-500 hover:bg-red-600 rounded text-white flex items-center transition duration-150 ease-in-out"
        >
          <MdArrowBackIos size={20} />
        </Link>

        <button
          className="transition duration-150 ease-in-out py-2 px-5 mr-2 text font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-red-700"
